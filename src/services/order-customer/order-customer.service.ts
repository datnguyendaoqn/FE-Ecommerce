...
import { CustomerOrderDetailApiResponseDto, CustomerOrderDetailResponseDto } from "@dtos/order-customer/CustomerOrderDetail.response";
...
export class CustomerOrderService {
    ...
    async getOrderDetail(orderId: number): Promise<CustomerOrderDetailResponseDto> {
        ...
        try {
            const res = await axiosInstance.get<CustomerOrderDetailApiResponseDto>(
    ...
    async cancelOrder(orderId: number, cancelRequest: CustomerCancelOrderRequestDto): Promise<CustomerOrderResponseDto> {
        ...
        try {
            const res = await axiosInstance.patch<CustomerOrderResponseDto>(
